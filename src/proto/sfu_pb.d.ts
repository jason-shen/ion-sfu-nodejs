...
export class SignalRequest extends jspb.Message { 
    getId(): string;
    setId(value: string): SignalRequest;


    hasJoin(): boolean;
    clearJoin(): void;
    getJoin(): JoinRequest | undefined;
    setJoin(value?: JoinRequest): SignalRequest;
    ...
    setDescription(value: Uint8Array | string): SignalRequest;


    hasTrickle(): boolean;
    clearTrickle(): void;
    getTrickle(): Trickle | undefined;
    setTrickle(value?: Trickle): SignalRequest;
...
export class SignalReply extends jspb.Message { 
    getId(): string;
    setId(value: string): SignalReply;


    hasJoin(): boolean;
    clearJoin(): void;
    getJoin(): JoinReply | undefined;
    setJoin(value?: JoinReply): SignalReply;
    ...
    getDescription_asU8(): Uint8Array;
    getDescription_asB64(): string;
    setDescription(value: Uint8Array | string): SignalReply;


    hasTrickle(): boolean;
    clearTrickle(): void;
    getTrickle(): Trickle | undefined;
    setTrickle(value?: Trickle): SignalReply;


    hasIceconnectionstate(): boolean;
    clearIceconnectionstate(): void;
    getIceconnectionstate(): string;
    setIceconnectionstate(value: string): SignalReply;


    hasError(): boolean;
    clearError(): void;
    getError(): string;
    setError(value: string): SignalReply;
...
export class JoinRequest extends jspb.Message { 
    getSid(): string;
    setSid(value: string): JoinRequest;

    getDescription(): Uint8Array | string;
    getDescription_asU8(): Uint8Array;
    getDescription_asB64(): string;
    setDescription(value: Uint8Array | string): JoinRequest;
...
export class JoinReply extends jspb.Message { 
    ...
    getDescription_asU8(): Uint8Array;
    getDescription_asB64(): string;
    setDescription(value: Uint8Array | string): JoinReply;
...
export class Trickle extends jspb.Message { 
    getTarget(): Trickle.Target;
    setTarget(value: Trickle.Target): Trickle;

    getInit(): string;
    setInit(value: string): Trickle;
