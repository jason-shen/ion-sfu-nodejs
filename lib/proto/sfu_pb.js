...
proto.sfu.SignalRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getJoin();
    if (f != null) {
        writer.writeMessage(2, f, proto.sfu.JoinRequest.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(4, f, proto.sfu.Trickle.serializeBinaryToWriter);
    }
};
/**
...
proto.sfu.SignalRequest.prototype.getJoin = function () {
    return /** @type{?proto.sfu.JoinRequest} */ (jspb.Message.getWrapperField(this, proto.sfu.JoinRequest, 2));
};
/**
...
proto.sfu.SignalRequest.prototype.getTrickle = function () {
    return /** @type{?proto.sfu.Trickle} */ (jspb.Message.getWrapperField(this, proto.sfu.Trickle, 4));
};
/**
...
proto.sfu.SignalReply.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getJoin();
    if (f != null) {
        writer.writeMessage(2, f, proto.sfu.JoinReply.serializeBinaryToWriter);
    }
    f = /** @type {!(string|Uint8Array)} */ (jspb.Message.getField(message, 3));
    if (f != null) {
        writer.writeBytes(3, f);
...
proto.sfu.SignalReply.prototype.getJoin = function () {
    return /** @type{?proto.sfu.JoinReply} */ (jspb.Message.getWrapperField(this, proto.sfu.JoinReply, 2));
};
/**
...
//# sourceMappingURL=sfu_pb.js.map